...
class _LoginFormState extends State {
  ...
  bool showpassword = true; //to visible the password
        ...
        body: Form(
          ...
          child: ListView(
            children: [
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      onPressed: () {
                        //Functionality used for statechange-setState
                        setState(() {
                          if(showpassword){
                            showpassword=false;
              ...
              SizedBox(
                height: 100,
              ), //to give space in b/w
              TextButton(
                  onPressed: () {}, child: Text("Not a User? Register Now."))
            ],
          ),
        ));
  }
